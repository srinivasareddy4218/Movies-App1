             ...
             steps {
                 script {
                     sshagent(credentials : ['sshkey']) {
                         sh " scp -o StrictHostKeyChecking=no  /var/lib/jenkins/workspace/movies-app/frontend/deployment/frontend-deployment.yaml azureuser@40.117.94.170:/home/cloud_user"
                        sh "whoami && pwd"
